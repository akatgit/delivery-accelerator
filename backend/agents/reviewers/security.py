"""SecurityReviewer (ARCHITECTURE_v2.0.md section 5.2 routing table).
...
ORG_STANDARD_CATEGORIES = ["security", "api_design"]


class SecurityReviewer(BaseReviewer):
    """Reviews the security domain, routed security/api_design org standards."""
